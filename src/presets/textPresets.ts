...
export const TEXT_PRESETS: TextPreset[] = [
  {
    ...
    name: "YouTube Bold",
    description:
      "Bold white text with black outline - perfect for YouTube thumbnails",
  ...
  },
  {
    ...
    description:
      "Clean white text with subtle outline for TikTok vertical videos",
    fontFamily: "system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif",
    fontWeight: "bold",
    fontSize: 64,
    fill: "#ffffff",
...
export function getAvailablePresets(hasPremiumAccess: boolean): TextPreset[] {
  if (hasPremiumAccess) {
    return TEXT_PRESETS;
  }
