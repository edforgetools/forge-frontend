...
export default function ThumbTool() {
    ...
    /** ===== UI ===== */
    return (_jsxs("div", { className: "p-4 space-y-4 text-white", children: [_jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [_jsx("label", { className: "text-sm", children: "Aspect" }), _jsxs("select", { className: "border rounded px-2 py-1 bg-black/40", value: aspect, onChange: (e) => setAspect(e.target.value), children: [_jsx("option", { value: "16:9", children: "16:9" }), _jsx("option", { value: "9:16", children: "9:16" }), _jsx("option", { value: "1:1", children: "1:1" })] }), stage === "edit" && (_jsx(UndoRedoBar, { canUndo: canUndo, canRedo: canRedo, onUndo: undo, onRedo: redo })), _jsxs("label", { className: "ml-4 inline-flex items-center gap-2 text-sm", children: [_jsx("input", { type: "checkbox", checked: flushSnap, onChange: (e) => setFlushSnap(e.target.checked) }), "Flush snap"] }), _jsx("div", { className: "text-xs text-neutral-400 ml-4", children: "Nudge: Arrow keys (1px) | Shift+Arrow (10px)" }), _jsx("div", { className: "ml-auto", children: _jsx(PlanSelector, {}) })] }), _jsxs("div", { className: "space-y-2", children: [_jsx("input", { type: "file", accept: "image/*,video/*", onChange: onBaseFile }), stage === "pick" && videoRef.current?.src && (_jsx("button", { className: "px-3 py-1 rounded bg-neutral-700", onClick: captureFrameFromVideo, children: "Capture frame" }))] }), stage === "edit" && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { children: "Zoom" }), _jsx("input", { type: "range", min: minScale, max: minScale * 6, step: 0.01, value: scale, onChange: (e) => setScale(parseFloat(e.target.value)) })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsxs("label", { className: "px-2 py-1 rounded bg-neutral-700 cursor-pointer", children: ["Choose overlay", _jsx("input", { type: "file", accept: "image/*", onChange: onOverlayFile, className: "hidden" })] }), _jsx("span", { className: "opacity-70 text-sm", children: ovUrl ? "Overlay loaded" : "No overlay" }), _jsx("span", { children: "Overlay size" }), _jsx("input", { type: "range", min: 0.2, max: 3, step: 0.01, value: ovScale, onChange: (e) => setOvScale(parseFloat(e.target.value)) }), _jsx("span", { children: "Overlay opacity" }), _jsx("input", { type: "range", min: 0.05, max: 1, step: 0.01, value: ovAlpha, onChange: (e) => setOvAlpha(parseFloat(e.target.value)) })] })] }), _jsx("div", { onWheel: onWheel, onPointerDown: onPointerDown, onPointerMove: onPointerMove, onPointerUp: onPointerUp, style: { width: CW, maxWidth: "100%" }, children: _jsx("canvas", { ref: canvasRef, width: CW, height: CH, style: {
                                width: "100%",
                                touchAction: "none",
                                border: "1px solid #555",
                                background: "#000",
                            } }) }), _jsxs("div", { className: "space-y-2", children: [_jsx("div", { className: "flex items-center gap-2", children: _jsx("input", { className: "px-2 py-1 rounded bg-neutral-800", value: txt, onChange: (e) => setTxt(e.target.value), placeholder: "YOUR TITLE" }) }), _jsxs("div", { className: "space-y-2", children: [_jsx("label", { className: "text-sm font-medium", children: "Text Presets" }), _jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2", children: getAvailablePresets(hasPremiumPresets()).map((preset) => {
                                        ...
                                        }) })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { children: "Size" }), _jsx("input", { type: "range", min: 16, max: 200, step: 1, value: txtSize, onChange: (e) => setTxtSize(parseInt(e.target.value)) }), _jsx("span", { children: "Opacity" }), _jsx("input", { type: "range", min: 0.05, max: 1, step: 0.01, value: txtAlpha, onChange: (e) => setTxtAlpha(parseFloat(e.target.value)) })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { children: "Stroke" }), _jsx("input", { type: "range", min: 0, max: 24, step: 1, value: txtStrokeW, onChange: (e) => setTxtStrokeW(parseInt(e.target.value)) }), _jsx("input", { type: "color", value: txtStroke, onChange: (e) => setTxtStroke(e.target.value) }), _jsx("span", { children: "Fill" }), _jsx("input", { type: "color", value: txtFill, onChange: (e) => setTxtFill(e.target.value) })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("button", { className: "px-3 py-1 rounded bg-neutral-700", onClick: exportUnder2MB, title: !hasUnlimitedExports()
                                            ...
                                            : "Unlimited exports", children: ["Export \u2264 2 MB", !hasUnlimitedExports() && (_jsxs("span", { className: "ml-1 text-xs opacity-70", children: ["(", Math.max(0, 5 -
                                                        parseInt(localStorage.getItem("forge_export_count") || "0")), " ", "left)"] }))] }), _jsx("button", { className: "px-3 py-1 rounded bg-neutral-700", onClick: startOver, children: "Start Over" }), _jsxs("label", { className: `inline-flex items-center gap-2 text-sm px-3 py-1 rounded transition-colors ${canRemoveWatermark()
                                            ? "bg-neutral-700 cursor-pointer hover:bg-neutral-600"
                                            : "bg-neutral-800 cursor-not-allowed opacity-60"}`, title: !canRemoveWatermark()
                                            ? "Upgrade to Pro to remove watermark"
                                            : "Toggle watermark visibility", children: [_jsx("input", { type: "checkbox", checked: wmOn, disabled: !canRemoveWatermark(), onChange: (e) => {
                                                ...
                                                }, className: "rounded" }), "Remove watermark ", !canRemoveWatermark() && "(Upgrade to Pro)"] })] })] })] })), _jsx("video", { ref: videoRef, className: "hidden", playsInline: true, muted: true }), _jsx(ExportModal, { isOpen: showExportModal, onClose: () => setShowExportModal(false), onDownload: handleDownloadAgain })] }));
}
