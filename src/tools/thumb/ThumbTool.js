      ...
      _jsxs("div", {
        ...
        children: [
          ...
          _jsxs("select", {
            id: "aspect-select",
            className:
              "border rounded px-2 py-1 bg-bg-secondary text-text-primary",
            value: aspect,
            ...
            children: [
              _jsx("option", {
                value: "16:9",
                children: "16:9 (YouTube, Landscape)",
              }),
              _jsx("option", {
                value: "9:16",
                children: "9:16 (TikTok, Instagram Stories)",
              }),
              _jsx("option", {
                value: "1:1",
                children: "1:1 (Instagram Post, Square)",
              }),
            ],
          }),
          _jsx("span", {
            id: "aspect-help",
            className: "sr-only",
            children: "Choose the aspect ratio for your thumbnail",
          }),
          stage === "edit" &&
            _jsx(UndoRedoBar, {
              canUndo: canUndo,
          ...
          _jsxs("label", {
            htmlFor: "flush-snap",
            className:
              "ml-4 inline-flex items-center gap-2 text-sm text-text-primary",
            children: [
              _jsx("input", {
                id: "flush-snap",
                type: "checkbox",
              ...
              _jsx("span", {
                id: "flush-snap-help",
                className: "sr-only",
                children: "Enable flush snap to align elements to canvas edges",
              }),
            ],
          }),
          _jsx("div", {
            className: "text-xs text-neutral-400 ml-4",
            children: "Nudge: Arrow keys (1px) | Shift+Arrow (10px)",
          }),
          _jsx("div", {
            className: "ml-auto",
            children: _jsx(PlanSelector, {}),
          }),
        ],
      }),
      _jsxs("div", {
        ...
        children: [
          _jsx("label", {
            ...
            children: "Upload base image or video",
          }),
          _jsx("input", {
            id: "base-file",
            type: "file",
          ...
          stage === "pick" &&
            ...
            _jsxs("button", {
              className:
                "px-3 py-1 rounded bg-neutral-700 text-text-primary hover:bg-neutral-600",
              ...
              children: [
                ...
                _jsx("span", {
                  id: "capture-help",
                  className: "sr-only",
                  children: "Capture current video frame as thumbnail base",
                }),
              ],
            }),
        ],
                ...
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsxs("span", {
                      ...
                      className: "sr-only",
                      children: [
                        "Adjust zoom level from ",
                        minScale.toFixed(2),
                        "x to",
                        " ",
                        (minScale * 6).toFixed(2),
                        "x",
                      ],
                    }),
                  ],
                ...
                _jsxs("div", {
                  ...
                  children: [
                    _jsxs("label", {
                      ...
                      className:
                        "px-2 py-1 rounded bg-neutral-700 cursor-pointer text-text-primary hover:bg-neutral-600",
                      children: [
                        "Choose overlay",
                        _jsx("input", {
                          id: "overlay-file",
                    ...
                    _jsx("span", {
                      id: "overlay-file-help",
                      className: "sr-only",
                      children:
                        "Upload an overlay image to add to your thumbnail",
                    }),
                    _jsx("span", {
                      className: "opacity-70 text-sm text-text-muted",
                      children: ovUrl ? "Overlay loaded" : "No overlay",
                    }),
                    _jsx("label", {
                      htmlFor: "overlay-size",
                      className: "text-sm text-text-primary",
                      children: "Overlay size",
                    }),
                    _jsx("input", {
                      id: "overlay-size",
                      type: "range",
                    ...
                    _jsx("span", {
                      id: "overlay-size-help",
                      className: "sr-only",
                      children: "Adjust overlay size from 0.2x to 3x",
                    }),
                    _jsx("label", {
                    ...
                    _jsx("span", {
                      id: "overlay-opacity-help",
                      className: "sr-only",
                      children: "Adjust overlay opacity from 5% to 100%",
                    }),
                  ],
                }),
              ],
                ...
                _jsxs("div", {
                  ...
                  children: [
                    _jsx("label", {
                      ...
                      children: "Text Presets",
                    }),
                    _jsx("div", {
                      className:
                        "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2",
                      children: getAvailablePresets(hasPremiumPresets()).map(
                        (preset) => {
                ...
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsx("span", {
                      id: "text-size-help",
                      className: "sr-only",
                      children: "Adjust text size from 16px to 200px",
                    }),
                    _jsx("label", {
                    ...
                    _jsx("span", {
                      id: "text-opacity-help",
                      className: "sr-only",
                      children: "Adjust text opacity from 5% to 100%",
                    }),
                  ],
                }),
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsx("span", {
                      id: "text-stroke-help",
                      className: "sr-only",
                      children: "Adjust text stroke width from 0px to 24px",
                    }),
                    _jsx("label", {
                ...
                _jsxs("div", {
                  ...
                  children: [
                    _jsxs("button", {
                      ...
                      title: !hasUnlimitedExports()
                        ? `Exports remaining: ${Math.max(
                            0,
                            5 -
                              parseInt(
                                localStorage.getItem("forge_export_count") ||
                                  "0"
                              )
                          )}`
                        : "Unlimited exports",
                    ...
                    _jsxs("label", {
                      ...
                      children: [
                        ...
                        "Remove watermark ",
                        !canRemoveWatermark() && "(Upgrade to Pro)",
                        _jsx("span", {
                          id: "watermark-help",
                          className: "sr-only",
                          children: canRemoveWatermark()
