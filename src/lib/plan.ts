 ...
 */
export function getPlan(plan: Plan = getCurrentPlan()) {
 ...
 */
export function canRemoveWatermark(): boolean {
 ...
 */
export function hasUnlimitedExports(): boolean {
 ...
 */
export function hasPremiumPresets(): boolean {
