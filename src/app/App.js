...
export default function App() {
    ...
    return (_jsxs(HelmetProvider, { children: [_jsxs(Helmet, { children: [_jsx("title", { children: "Forge Tools - Free AI-Powered Content Creation Tools" }), _jsx("meta", { name: "description", content: "Create professional content with Forge's free AI tools: YouTube thumbnails, podcast captions, audiograms, and video clips. Boost your social media presence with our powerful content creation suite." }), _jsx("meta", { name: "keywords", content: "content creation tools, AI tools, YouTube thumbnail maker, podcast caption generator, audiogram creator, video clipper, social media tools, free content tools" }), _jsx("meta", { property: "og:title", content: "Forge Tools - Free AI-Powered Content Creation Tools" }), _jsx("meta", { property: "og:description", content: "Create professional content with Forge's free AI tools: YouTube thumbnails, podcast captions, audiograms, and video clips. Boost your social media presence with our powerful content creation suite." }), _jsx("meta", { property: "og:type", content: "website" }), _jsx("meta", { name: "twitter:card", content: "summary_large_image" }), _jsx("meta", { name: "twitter:title", content: "Forge Tools - Free AI-Powered Content Creation Tools" }), _jsx("meta", { name: "twitter:description", content: "Create professional content with Forge's free AI tools: YouTube thumbnails, podcast captions, audiograms, and video clips. Boost your social media presence with our powerful content creation suite." }), _jsx("script", { type: "application/ld+json", children: JSON.stringify({
                        ...
                        }) })] }), _jsx("a", { href: "#main-content", className: "skip-link", children: "Skip to main content" }), _jsxs("main", { id: "main-content", className: "p-4 max-w-5xl mx-auto", children: [_jsxs("section", { className: "mb-8", "aria-labelledby": "main-heading", children: [_jsx("h1", { id: "main-heading", className: "text-4xl font-bold mb-6 text-center text-white", children: "Free AI-Powered Content Creation Tools" }), _jsxs("div", { className: "max-w-4xl mx-auto space-y-4 text-lg leading-relaxed text-white mb-8", children: [_jsxs("p", { children: ["Create professional content with Forge's suite of free AI-powered tools. Generate eye-catching YouTube thumbnails, engaging podcast captions, stunning audiograms, and viral-ready video clips. Perfect for content creators, podcasters, and marketers looking to maximize their social media impact. Learn more in our", _jsx("a", { href: "/blog", className: "link-primary", children: "comprehensive blog" }), "with expert tips and tutorials."] }), _jsx("h2", { className: "text-2xl font-semibold mt-8 mb-4", children: "Our Free Content Creation Tools" }), _jsxs("div", { className: "grid md:grid-cols-2 gap-6 mb-8", role: "list", "aria-label": "Available tools", children: [_jsxs("div", { className: "bg-gray-800 rounded-lg p-6", role: "listitem", children: [_jsx("h3", { className: "text-xl font-semibold mb-3", children: _jsx("a", { href: "/free-youtube-thumbnail-tool", className: "link-primary", onClick: () => trackToolDiscovery("youtube-thumbnail", "homepage"), children: "YouTube Thumbnail Generator" }) }), _jsx("p", { className: "text-gray-300", children: "Create eye-catching YouTube thumbnails that get more clicks. Upload images, add text overlays, and design professional thumbnails optimized for maximum engagement." })] }), _jsxs("div", { className: "bg-gray-800 rounded-lg p-6", role: "listitem", children: [_jsx("h3", { className: "text-xl font-semibold mb-3", children: _jsx("a", { href: "/free-podcast-caption-generator", className: "link-primary", onClick: () => trackToolDiscovery("podcast-caption", "homepage"), children: "Podcast Caption Generator" }) }), _jsx("p", { className: "text-gray-300", children: "Generate engaging social media captions from your podcast episodes. Upload audio files to get automatic transcription and AI-optimized captions for all platforms." })] }), _jsxs("div", { className: "bg-gray-800 rounded-lg p-6", role: "listitem", children: [_jsx("h3", { className: "text-xl font-semibold mb-3", children: _jsx("a", { href: "/free-ai-audiogram-generator", className: "link-primary", onClick: () => trackToolDiscovery("ai-audiogram", "homepage"), children: "AI Audiogram Creator" }) }), _jsx("p", { className: "text-gray-300", children: "Transform your audio content into stunning visual audiograms. Perfect for social media marketing with automatic transcription and professional design." })] }), _jsxs("div", { className: "bg-gray-800 rounded-lg p-6", role: "listitem", children: [_jsx("h3", { className: "text-xl font-semibold mb-3", children: _jsx("a", { href: "/clip-short-video-automatically", className: "link-primary", onClick: () => trackToolDiscovery("video-clipper", "homepage"), children: "Automatic Video Clipper" }) }), _jsx("p", { className: "text-gray-300", children: "Automatically generate short video clips from longer content. Our AI identifies the most engaging moments for TikTok, Instagram Reels, and YouTube Shorts." })] })] }), _jsx("h2", { className: "text-2xl font-semibold mt-8 mb-4", children: "Why Choose Forge Tools?" }), _jsx("p", { children: "All our tools are completely free to use with no watermarks or limitations. Powered by advanced AI technology, they're designed to help content creators save time while producing professional-quality content that drives engagement and grows your audience across all social media platforms." }), _jsx("h2", { className: "text-2xl font-semibold mt-8 mb-4", children: "Learn & Grow" }), _jsx("p", { className: "mb-6", children: "Get expert tips, tutorials, and insights to maximize your content creation potential. Our blog covers everything from YouTube optimization to social media strategies." }), _jsxs("div", { className: "bg-gray-800 rounded-lg p-6 mb-8", children: [_jsx("h3", { className: "text-xl font-semibold mb-3", children: _jsx("a", { href: "/blog", className: "link-primary", onClick: () => trackToolDiscovery("blog", "homepage"), children: "\uD83D\uDCDA Content Creation Blog" }) }), _jsx("p", { className: "text-gray-300", children: "Learn how to create professional content with our comprehensive guides. From YouTube thumbnail design to podcast caption strategies, we've got you covered." })] })] })] }), _jsxs("div", { className: "flex justify-between items-center mb-4", children: [_jsxs("nav", { className: "flex gap-2", role: "navigation", "aria-label": "Tool selection", children: [_jsx("button", { className: `btn ${tab === "captions" ? "border-white" : ""}`, onClick: () => {
                                            setTab("captions");
                                            trackActivity("tab_switch");
                                            trackToolDiscovery("captions", "homepage");
                                        }, "aria-pressed": tab === "captions", children: "Captions" }), _jsx("button", { className: `btn ${tab === "thumb" ? "border-white" : ""}`, onClick: () => {
                                            setTab("thumb");
                                            trackActivity("tab_switch");
                                            trackToolDiscovery("thumbnail", "homepage");
                                        }, "aria-pressed": tab === "thumb", children: "Thumbnail" })] }), _jsx(PlanSelector, {})] }), tab === "captions" ? _jsx(ForgePlusDashboard, {}) : _jsx(ThumbTool, {})] }), _jsx("footer", { className: "mt-8 py-4 border-t border-gray-700 text-center text-gray-400 text-sm", role: "contentinfo", children: _jsx("p", { children: "\u00A9 2024 Forge Tools. All rights reserved." }) })] }));
}
