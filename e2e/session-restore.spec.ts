...
test.describe("Session Restore", () => {
  ...
  test("should save and restore session data on page reload", async ({ page }) => {
    await page.goto("/");
    ...
    // Add a text overlay
    await page.fill('input[placeholder="Enter text for overlay..."]', "Test Overlay");
  ...
  test("should toggle session restore on/off", async ({ page }) => {
    ...
    // Add some data
    await page.fill('input[placeholder="Enter text for overlay..."]', "Test Data");
    await page.click('button:has-text("Add Text")');
  ...
  test("should handle IndexedDB unavailability gracefully", async ({ page }) => {
  ...
  test("should show restore indicator during session restore", async ({ page }) => {
    await page.goto("/");
